...
public class ArmorDurability {
    private static final ResourceLocation EmptyBootsTexture = ResourceLocation.tryBuild("minecraft", "textures/item/empty_armor_slot_boots.png");
    private static final ResourceLocation EmptyLeggingsTexture = ResourceLocation.tryBuild("minecraft", "textures/item/empty_armor_slot_leggings.png");
    private static final ResourceLocation EmptyChestplateTexture = ResourceLocation.tryBuild("minecraft", "textures/item/empty_armor_slot_chestplate.png");
    private static final ResourceLocation EmptyHelmetTexture = ResourceLocation.tryBuild("minecraft", "textures/item/empty_armor_slot_helmet.png");
