...
import static com.FuFu.CabbageJellyPack.GuiText.RenderLossUI.RESET_SHULKERBOX;
...
public abstract class TransparentShulkerBoxScreenMixin extends AbstractContainerScreen<ShulkerBoxMenu> {
    ...
    protected void renderBg(@NotNull GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (RESET_SHULKERBOX!= null) {
            guiGraphics.blit(RESET_SHULKERBOX, i, j, 0, 0, this.imageWidth, this.imageHeight);
        }
